      ...
      <div style={{display:'flex', flexDirection:'column', alignItems:'center', borderRadius:'0.4rem', width: '70vw', backgroundColor:'whitesmoke'}}>
        ...
        <div style={{ width:'60%'}}>
          <Box component="form" sx={{'& > :not(style)': { width: '100%' }}} noValidate autoComplete="off" >
            <TextField id="outlined-basic" label="Description" variant="outlined" value={date} onChange={handleChangeDescription}/>
          </Box>
        </div>

        <div style={{ width:'60%'}}>
          <Box component="form" sx={{'& > :not(style)': { width: '100%' }}} noValidate autoComplete="off" >
            <TextField id="outlined-basic" label="YYYY-MM-DD" variant="outlined" value={description} onChange={handleChangeDate}/>
          </Box>
        </div>
